...
| :heavy_check_mark: | Appendix |          Model, Exp 1          |                                              Participant strategies for Experiment #1                                               | Run above (CM_MainExperiment.stdout)                                                                                                                       |                                                                                          Run above                                                                                          |
...
|                    | Appendix |             Exp 1              |     Does the addition of a discount rate and power utility function explain the data better than the planning depth parameter?      |                                                                                                                                                            |                                                                                                                                                                                             |
