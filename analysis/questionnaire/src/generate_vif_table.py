...
if __name__ == "__main__":
    ...
    analysis_obj.cost_details['latex_mapping'] = {**{
       f"${key}$" : val for key, val in analysis_obj.cost_details['latex_mapping'].items()},
                                                  "const": "Constant",
                                                  "female": "Gender: Woman",
    ...
    for variable, vif_value in vif_dict.items():
        print(
            f"{analysis_obj.cost_details['latex_mapping'][variable]  if variable in analysis_obj.cost_details['latex_mapping'] else variable} & {vif_value:.2f} \\\ ")  # noqa
